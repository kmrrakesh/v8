...
.ui[class*="right labeled"].input > input:focus {
  border-right-color: #1D252D !important;
}
...
/* Removed borders from labeled inputs. !important is required to override form styles. */
