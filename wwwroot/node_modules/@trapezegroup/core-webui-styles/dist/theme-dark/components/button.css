...
.ui.button {
  ...
  -webkit-box-shadow: 0 0 0 1px transparent inset, 0 0 0 0 #4E5962 inset;
          box-shadow: 0 0 0 1px transparent inset, 0 0 0 0 #4E5962 inset;
...
.ui.facebook.button {
  ...
  text-shadow: none;
  background-image: none;
  -webkit-box-shadow: 0 0 0 0 #4E5962 inset;
          box-shadow: 0 0 0 0 #4E5962 inset;
}
...
.ui.basic.button {
  ...
  text-transform: none;
  text-shadow: none !important;
  -webkit-box-shadow: 0 0 0 1px #4E5962 inset;
          box-shadow: 0 0 0 1px #4E5962 inset;
}
.ui.basic.buttons {
  -webkit-box-shadow: none;
          box-shadow: none;
...
.ui.basic.button:hover {
  background: #333F48;
  color: rgba(0, 0, 0, 0.6);
  -webkit-box-shadow: 0 0 0 1px #4E5962 inset, 0 0 0 0 #4E5962 inset;
          box-shadow: 0 0 0 1px #4E5962 inset, 0 0 0 0 #4E5962 inset;
}
...
.ui.basic.button:active {
  background: #F8F8F8;
  color: rgba(0, 0, 0, 0.6);
  -webkit-box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.15) inset, 0 1px 4px 0 #4E5962 inset;
          box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.15) inset, 0 1px 4px 0 #4E5962 inset;
}
...
/* Vertical */
.ui.basic.buttons .button:hover {
  -webkit-box-shadow: 0 0 0 1px #4E5962 inset, 0 0 0 0 #4E5962 inset inset;
          box-shadow: 0 0 0 1px #4E5962 inset, 0 0 0 0 #4E5962 inset inset;
}
.ui.basic.buttons .button:active {
  -webkit-box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.15) inset, 0 1px 4px 0 #4E5962 inset inset;
          box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.15) inset, 0 1px 4px 0 #4E5962 inset inset;
}
.ui.basic.buttons .active.button {
  -webkit-box-shadow: '';
          box-shadow: '';
...
.ui.attached.button {
  ...
  margin: 0;
  border-radius: 0;
  -webkit-box-shadow: 0 0 0 1px #4E5962;
...
.ui.inverted.primary.button {
  background-color: transparent;
  -webkit-box-shadow: 0 0 0 2px #8A1538 inset;
          box-shadow: 0 0 0 2px #8A1538 inset;
  color: #8A1538;
}
...
.ui.inverted.primary.basic.button:hover {
  -webkit-box-shadow: 0 0 0 2px #620a24 inset;
          box-shadow: 0 0 0 2px #620a24 inset;
  color: #8A1538;
}
.ui.inverted.primary.basic.buttons .button:focus,
.ui.inverted.primary.basic.buttons .button:focus,
.ui.inverted.primary.basic.button:focus {
  -webkit-box-shadow: 0 0 0 2px #6f0726 inset;
          box-shadow: 0 0 0 2px #6f0726 inset;
  color: #8A1538;
}
.ui.inverted.primary.basic.buttons .active.button,
.ui.inverted.primary.buttons .basic.active.button,
.ui.inverted.primary.basic.active.button {
  -webkit-box-shadow: 0 0 0 2px #7b0a2c inset;
          box-shadow: 0 0 0 2px #7b0a2c inset;
  color: #8A1538;
}
.ui.inverted.primary.basic.buttons .button:active,
.ui.inverted.primary.buttons .basic.button:active,
.ui.inverted.primary.basic.button:active {
  -webkit-box-shadow: 0 0 0 2px #5e0e26 inset;
          box-shadow: 0 0 0 2px #5e0e26 inset;
  color: #8A1538;
}
...
.ui.inverted.secondary.basic.button:hover {
  -webkit-box-shadow: 0 0 0 2px #303e4d inset;
          box-shadow: 0 0 0 2px #303e4d inset;
  color: #1D252D;
}
.ui.inverted.secondary.basic.buttons .button:focus,
.ui.inverted.secondary.basic.buttons .button:focus,
.ui.inverted.secondary.basic.button:focus {
  -webkit-box-shadow: 0 0 0 2px #2b3948 inset;
          box-shadow: 0 0 0 2px #2b3948 inset;
  color: #1D252D;
}
.ui.inverted.secondary.basic.buttons .active.button,
.ui.inverted.secondary.buttons .basic.active.button,
.ui.inverted.secondary.basic.active.button {
  -webkit-box-shadow: 0 0 0 2px #25323e inset;
          box-shadow: 0 0 0 2px #25323e inset;
  color: #1D252D;
}
.ui.inverted.secondary.basic.buttons .button:active,
.ui.inverted.secondary.buttons .basic.button:active,
.ui.inverted.secondary.basic.button:active {
  -webkit-box-shadow: 0 0 0 2px #313e4c inset;
          box-shadow: 0 0 0 2px #313e4c inset;
  color: #1D252D;
}
...
.ui.inverted.red.button {
  background-color: transparent;
  -webkit-box-shadow: 0 0 0 2px #B30015 inset;
          box-shadow: 0 0 0 2px #B30015 inset;
  color: #B30015;
}
...
.ui.inverted.red.basic.button:hover {
  -webkit-box-shadow: 0 0 0 2px #80000f inset;
          box-shadow: 0 0 0 2px #80000f inset;
  color: #B30015;
}
.ui.inverted.red.basic.buttons .button:focus,
.ui.inverted.red.basic.buttons .button:focus,
.ui.inverted.red.basic.button:focus {
  -webkit-box-shadow: 0 0 0 2px #8a0010 inset;
          box-shadow: 0 0 0 2px #8a0010 inset;
  color: #B30015;
}
.ui.inverted.red.basic.buttons .active.button,
.ui.inverted.red.buttons .basic.active.button,
.ui.inverted.red.basic.active.button {
  -webkit-box-shadow: 0 0 0 2px #9a0012 inset;
          box-shadow: 0 0 0 2px #9a0012 inset;
  color: #B30015;
}
...
.ui.inverted.grey.button {
  background-color: transparent;
  -webkit-box-shadow: 0 0 0 2px #4E5962 inset;
          box-shadow: 0 0 0 2px #4E5962 inset;
  color: #FFFFFF;
}
...
.ui.inverted.grey.basic.button:hover {
  -webkit-box-shadow: 0 0 0 2px #d4d8db inset;
          box-shadow: 0 0 0 2px #d4d8db inset;
  color: #FFFFFF;
}
.ui.inverted.grey.basic.buttons .button:focus,
.ui.inverted.grey.basic.buttons .button:focus,
.ui.inverted.grey.basic.button:focus {
  -webkit-box-shadow: 0 0 0 2px #dadde0 inset;
          box-shadow: 0 0 0 2px #dadde0 inset;
  color: #F0F1F2;
}
.ui.inverted.grey.basic.buttons .active.button,
.ui.inverted.grey.buttons .basic.active.button,
.ui.inverted.grey.basic.active.button {
  -webkit-box-shadow: 0 0 0 2px #e2e4e6 inset;
          box-shadow: 0 0 0 2px #e2e4e6 inset;
  color: #FFFFFF;
}
.ui.inverted.grey.basic.buttons .button:active,
.ui.inverted.grey.buttons .basic.button:active,
.ui.inverted.grey.basic.button:active {
  -webkit-box-shadow: 0 0 0 2px #d5d8da inset;
          box-shadow: 0 0 0 2px #d5d8da inset;
  color: #FFFFFF;
}
