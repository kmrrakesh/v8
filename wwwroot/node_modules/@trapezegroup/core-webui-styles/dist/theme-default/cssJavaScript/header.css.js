...
.ui.inverted.block.header {
  background: #333F48 -webkit-gradient(linear, left top, left bottom, from(transparent), to(rgba(0, 0, 0, 0.05)));
  background: #333F48 -webkit-linear-gradient(transparent, rgba(0, 0, 0, 0.05));
  background: #333F48 linear-gradient(transparent, rgba(0, 0, 0, 0.05));
  -webkit-box-shadow: none;
          box-shadow: none;
  border-bottom: none;
}
...
.ui.primary.dividing.header {
  border-bottom: 2px solid #099FAC;
}
...
.ui.inverted.red.dividing.header {
  border-bottom: 2px solid #B30015;
}
.ui.orange.header {
  color: #ED8B00;
}
