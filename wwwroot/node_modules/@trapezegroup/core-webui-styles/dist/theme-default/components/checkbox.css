...
.ui.toggle.checkbox input:checked ~ label:before {
  background-color: #099FAC !important;
}
...
/* Inverted Checkbox styles */
.ui.inverted .checkbox label,
.ui.inverted .checkbox + label,
.ui.inverted .checkbox input:focus ~ label {
...
.ui.inverted .radio.checkbox input:focus:checked ~ .box:before,
.ui.inverted .radio.checkbox input:focus:checked ~ label:before,
...
.ui.inverted .radio.checkbox input:focus:checked ~ .box:after,
.ui.inverted .radio.checkbox input:focus:checked ~ label:after {
  background-color: #FFFFFF;
}

/* Inverted Toggle styles */
...
.ui.inverted .toggle.checkbox input ~ .box:after,
.ui.inverted .toggle.checkbox input ~ label:after {
  -webkit-box-shadow: none;
          box-shadow: none;
}
...
/* Copied over from default theme*/
@font-face {
  font-family: 'Checkbox';
  src: url(data:application/x-font-ttf;charset=utf-8;base64,) format('truetype');
}
