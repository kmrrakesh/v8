...
/* Item Hover */
:hover(.ui.dropdown.error) > .menu > .item:hover {
  background-color: #FFF2F2;
}

/* Item Active */
:hover(.ui.dropdown.error) > .menu .active.item {
...
.ui.labeled.input .label:first-child + .ui.selection.dropdown {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}
.ui.labeled.input > .ui.selection.dropdown,
.ui.labeled.input > .ui.selection.dropdown:hover,
.ui.labeled.input > .ui.selection.dropdown:focus,
.ui.labeled.input > .ui.selection.active.dropdown,
.ui.labeled.input > .ui.selection.active.dropdown:hover {
  border-left: 0;
  border-color: var(--primary-border-color);
}
.ui.labeled.input > .ui.selection.active.dropdown .menu,
.ui.labeled.input > .ui.selection.active.dropdown:hover .menu,
.ui.labeled.input > .ui.selection.active.dropdown:focus .menu {
  border-color: var(--primary-border-color);
}
