...
.ui.slider.checkbox label:after {
  ...
  z-index: 2;
  border: none;
  -webkit-box-shadow: 0 1px 2px 0 #4E5962, 0 0 0 1px #4E5962 inset;
          box-shadow: 0 1px 2px 0 #4E5962, 0 0 0 1px #4E5962 inset;
  width: 1.5rem;
  height: 1.5rem;
  top: -0.25rem;
  left: 0;
...
.ui.toggle.checkbox input:checked ~ label:before {
  background-color: var(--prim-button-bg) !important;
  border-color: var(--prim-button-bg);
}
...
.ui.inverted.toggle.checkbox input:focus:checked ~ label:before {
  background-color: #6f0726 !important;
}
