...
.ui.segment {
  position: relative;
  background: #FFFFFF;
  -webkit-box-shadow: 0 1px 2px 0 #4E5962;
          box-shadow: 0 1px 2px 0 #4E5962;
  margin: 1rem 0;
  padding: 1em 1em;
...
.ui.segments:not(.horizontal) > .segment:last-child {
  ...
  margin-top: 0;
  margin-bottom: 0;
  -webkit-box-shadow: 0 1px 2px 0 #4E5962, none;
          box-shadow: 0 1px 2px 0 #4E5962, none;
...
.ui.secondary.inverted.segment {
  background: #45586b -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(255, 255, 255, 0.2)), to(rgba(255, 255, 255, 0.2)));
  background: #45586b -webkit-linear-gradient(rgba(255, 255, 255, 0.2) 0, rgba(255, 255, 255, 0.2) 100%);
  background: #45586b linear-gradient(rgba(255, 255, 255, 0.2) 0, rgba(255, 255, 255, 0.2) 100%);
  color: #333F48;
}
...
.ui.tertiary.inverted.segment {
  background: #637e9a -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(255, 255, 255, 0.35)), to(rgba(255, 255, 255, 0.35)));
  background: #637e9a -webkit-linear-gradient(rgba(255, 255, 255, 0.35) 0, rgba(255, 255, 255, 0.35) 100%);
  background: #637e9a linear-gradient(rgba(255, 255, 255, 0.35) 0, rgba(255, 255, 255, 0.35) 100%);
  color: #333F48;
}
