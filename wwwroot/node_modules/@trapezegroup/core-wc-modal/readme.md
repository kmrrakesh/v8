...
Basic components for app functionality
    ...
    npm install @trapezegroup/core-wc-modal

## Usage

### Modal
    
    import '@trapezegroup/core-wc-modal/src/components/modal/core-modal.js';

    ....

    this.innerHTML = `<core-modal>Modal Contents</core-modal>`;
